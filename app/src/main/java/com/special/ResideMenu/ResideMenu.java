...
public class ResideMenu extends FrameLayout {
    ...
    public void addMenuHeader(String username, String email, int direction) {
        if (direction == DIRECTION_LEFT) {
            View header = scrollViewLeftMenu.findViewById(R.id.header_left_menu);
            header.setVisibility(VISIBLE);
            TextView usernameTv = (TextView) header.findViewById(R.id.username_tv);
            usernameTv.setText(username);
            TextView emailTv = (TextView) header.findViewById(R.id.email_tv);
            emailTv.setText(email);
            Log.i("credentials", username + " " + email + "");
        }
    }
